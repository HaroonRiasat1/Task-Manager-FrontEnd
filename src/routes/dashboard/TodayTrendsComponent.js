        ...
        >
            ...
            >
                <Row wrap horizontal='space-between'>
                    <Column>
                        <span className={classes.graphTitle}>Software Engineering Project</span>
                        <span className={classes.graphSubtitle}>{date}</span>
                    </Column>
            ...
            <Column flexGrow={3} flexBasis='342px' breakpoints={{ 1024: classes.stats }}>
                {renderStat('Assigned', '40')}
                {renderStat('Received', '10')}
                {renderStat('Average first response time', '2h')}
